...
--CAPES
	...
	AMBUBLOCK_BACK 		= {name="Rudianos's Mantle", augments={'HP+60, M.Eva./Eva.+20, Enm.+10, M.Eva+10, Block Chance+5%',}}						--make this
	AMBUPDT_BACK 		= {name="Rudianos's Mantle", augments={'HP+60, M.Eva/Eva+20, M.Eva+10, Enm.+10, PDT-10%',}}									--make this
	AMBUSTP_BACK 		= {name="Rudianos's Mantle", augments={'HP+60, Acc/Att+20, Acc+10, STP+10, Resist All+10%',}}								--make this
	AMBUWSD_BACK 		= {name="Rudianos's Mantle", augments={'HP+60, Acc/Att+20, STR+10, WSD+10%, PDT-10%',}}										--make this
	AMBUSIRD_BACK 		= {name="Rudianos's Mantle", augments={'HP+60, Acc/Att+20, STR+10, WSD+10%, PDT-10%',}}										--make this
