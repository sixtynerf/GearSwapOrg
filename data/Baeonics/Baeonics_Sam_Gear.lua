...
--Relic Gear
  ...
  RELIC_BODY = {name="Sakonji Domaru +3"}
...
-- Precast sets to enhance JAs
  sets.precast.JA.Meditate = {head=AF_HEAD,hands=RELIC_HANDS,back=AMBUWS_BACK}
  ...
  sets.precast.Step = 
  {
    head=FLAMMA_HEAD,neck="Moonlight Nodowa",ear1="Mache Earring +1",ear2="Telos Earring",
    body=RELIC_BODY,hands=FLAMMA_HANDS,ring1="Ramuh Ring +1",ring2="Ramuh Ring +1",
    back=AMBUSTP_BACK,waist="Olseni Belt",legs=AF_LEGS,feet=AF_FEET
  }
  sets.precast.JA['Violent Flourish'] = 
  {
    ammo="Pemphredo Tathlum",
    head=FLAMMA_HEAD,neck="Sanctity Necklace",ear1="Digni. Earring",ear2="Moonshade Earring",
    body=FLAMMA_BODY,hands=FLAMMA_HANDS,ring1="Ramuh Ring +1",ring2="Ramuh Ring +1",
    back=AMBUWS_BACK,waist="Eschan Stone",legs=FLAMMA_LEGS,feet=FLAMMA_FEET
  }

    -- Waltz set (chr and vit)
  sets.precast.Waltz = 
  {
    head=FLAMMA_HEAD,neck="Unmoving Collar +1",ear1="Handler's Earring +1",ear2="Handler's Earring",
    body="Tartarus Platemail",hands=FLAMMA_HANDS,ring1="Asklepian Ring",ring2="Valseur's Ring",
    back="Moonlight Cape",waist="Chaac Belt",legs=AF_LEGS,feet=RELIC_FEET
  }
...
-- Default set for any weaponskill that isn't any more specifically defined
  ...
  sets.precast.WS.SomeAcc = set_combine(sets.precast.WS, {feet=AF_LEGS})
  sets.precast.WS.Acc = set_combine(sets.precast.WS, {head=AF_HEAD,body=RELIC_BODY,feet=AF_LEGS})
  sets.precast.WS.FullAcc = set_combine(sets.precast.WS, {head=AF_HEAD,neck="Moonlight Nodowa",ear1="Mache Earring +1",ear2="Telos Earring",body=RELIC_BODY,hands=AF_HANDS,ring1="Ramuh Ring +1",feet=AF_LEGS})
  ...
  back=AMBUWS_BACK,waist="Fotia Belt",legs=AF_LEGS,feet=AF_LEGS
  }
  ...
  sets.precast.WS['Apex Arrow'].Fodder = set_combine(sets.precast.WS['Apex Arrow'], {})
    ...
    sets.midcast.FastRecast = {
        ...
        back="Moonlight Cape",waist="Tempus Fugit",legs=AF_LEGS,feet="Amm Greaves"}
    ...
    sets.midcast.RA = {
        ...
        body="Kyujutsugi",hands="Buremte Gloves",ring1="Ilabrat Ring",ring2="Regal Ring",
        back=AMBUSTP_BACK,waist="Carrier's Sash",legs=AF_LEGS,feet=AF_LEGS}
    ...
    sets.resting = {ammo="Staunch Tathlum +1",
        ...
        body="Sacro Breastplate",hands=RELIC_HANDS,ring1="Defending Ring",ring2="Dark Ring",
        back="Moonlight Cape",waist="Flume Belt +1",legs=AF_LEGS,feet=FLAMMA_FEET}
    ...
    sets.idle.Weak = {ammo="Staunch Tathlum +1",
        ...
        body="Twilight Mail",hands=RELIC_HANDS,ring1="Defending Ring",ring2="Dark Ring",
        back="Moonlight Cape",waist="Flume Belt +1",legs=FLAMMA_LEGS,feet="Danzo Sune-ate"}
    ...
    sets.defense.PDT = {ammo="Staunch Tathlum +1",
        ...
        body="Nyame Mail",hands=AF_HANDS,ring1="Defending Ring",ring2="Patricius Ring",
        back="Moonlight Cape",waist="Ioskeha Belt",legs=AF_LEGS,feet="Nyame Sollerets"}
    ...
    sets.engaged.FullAcc = {ammo="Aurgelmir Orb +1",
        ...
        body="Ken. Samue",hands=AF_HANDS,ring1="Ramuh Ring +1",ring2="Regal Ring",
        back=AMBUSTP_BACK,waist="Olseni Belt",legs=AF_LEGS,feet=AF_LEGS}
...
--[[Right now Adoulin sets are the same as non-Adoulin.
    ...
    sets.engaged.Adoulin.SomeAcc = {ammo="Aurgelmir Orb +1",
        ...
        body="Kasuga Domaru +1",hands=FLAMMA_HANDS,ring1="Niqmaddu Ring",ring2="Ilabrat Ring",
    ...
    sets.engaged.Adoulin.FullAcc = {ammo="Aurgelmir Orb +1",
        head=FLAMMA_HEAD,neck="Combatant's Torque",ear1="Mache Earring +1",ear2="Telos Earring",
        body="Kasuga Domaru +1",hands=FLAMMA_HANDS,ring1="Ramuh Ring +1",ring2="Ramuh Ring +1",
